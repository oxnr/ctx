window.VC_DATA = {
  ...
  tools: [
    ...
    { id: "flash-moe", name: "flash-moe", desc: "SSD-streaming inference for MoE models — runs Qwen 397B on 48GB MacBook at 5.7 tok/s by streaming expert weights from flash storage, 2-bit requantization, Metal GPU pipeline", type: "open-source", url: "https://github.com/danveloper/flash-moe", github: "https://github.com/danveloper/flash-moe", directLayers: ["inference"], indirectLayers: [], yc: null, subcategories: ["local-runners"]},
