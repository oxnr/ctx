window.VC_DATA = {
  ...
  tools: [
    ...
    { id: "gstack", name: "gstack", desc: "Claude Code operating system — nine cognitive modes (CEO review, tech lead, QA, ship) with browser automation, diff-aware testing, and parallel execution", type: "open-source", url: "https://github.com/garrytan/gstack", github: "https://github.com/garrytan/gstack", directLayers: ["harness", "orchestration"], indirectLayers: ["integrations", "eval"], yc: null, layerDetails: { harness: "Configures Claude Code's harness with cognitive mode separation (planning ≠ review ≠ shipping), persistent Playwright browser for visual verification, and diff-aware QA loops", orchestration: "Designed for parallel execution via Conductor — 10+ isolated Claude Code sessions each with dedicated browser and state", integrations: "Browser automation (Playwright), Greptile PR review triage, git integration", eval: "QA health scores, regression testing, Greptile batting average tracking" }, subcategories: ["constraints", "verification-loops", "tool-infrastructure", "context-management"]},
