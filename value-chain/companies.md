...
| DeepSpeed | Distributed model-training infrastructure with ZeRO state partitioning, offloading, and parallelism controls. | open-source | [deepspeedai/DeepSpeed](https://github.com/deepspeedai/DeepSpeed) | - |
...
| ERNIE-Image | Text-to-image model family with downloadable standard and Turbo weights and optional prompt enhancement. | open-weight | [baidu/ERNIE-Image](https://github.com/baidu/ERNIE-Image) | - |
| TimesFM | Time-series forecasting research code with pretrained-model interfaces for covariates and quantile prediction. | research | [google-research/timesfm](https://github.com/google-research/timesfm) | - |
| nanochat | Educational language-model pipeline covering tokenization, pretraining, post-training, evaluation, and chat inference. | open-source | [karpathy/nanochat](https://github.com/karpathy/nanochat) | - |
| Attention Residuals | Research on attention-weighted aggregation of earlier Transformer layer representations, including a blockwise variant. | research | [MoonshotAI/Attention-Residuals](https://github.com/MoonshotAI/Attention-Residuals) | - |
| Kimi K3 | Moonshot AI open-weight multimodal mixture-of-experts model for text and visual inputs, coding and tool-using workflows. | open-weight | [MoonshotAI/Kimi-K3](https://github.com/MoonshotAI/Kimi-K3) | - |
| Qwen3.8 | Qwen open-weight model family with multimodal inputs, configurable reasoning and support for coding and tool-using workflows. | open-weight | [QwenLM/Qwen3.8](https://github.com/QwenLM/Qwen3.8) | - |
| Qwen3.8-Flash-Next | Open-weight multimodal mixture-of-experts model combining hybrid linear and sparse attention, gated residual connections and N-gram embeddings. | open-weight | [QwenLM/Qwen3.8-Flash-Next](https://github.com/QwenLM/Qwen3.8-Flash-Next) | - |
| Tencent Hy4 preview | Mixture-of-experts language model with released instruction-tuned weights and an FP8 variant. | open-weight | [Tencent-Hunyuan/Hy4-preview](https://github.com/Tencent-Hunyuan/Hy4-preview) | - |
...
| PMetal | Rust tooling for language-model adapter training and inference with MLX and Metal on Apple silicon. | open-source | [Epistates/pmetal](https://github.com/Epistates/pmetal) | - |
| MLX LM LoRA | MLX-based language-model training toolkit for Apple Silicon with adapter fine-tuning and preference-optimization methods. | open-source | [Goekdeniz-Guelmez/mlx-lm-lora](https://github.com/Goekdeniz-Guelmez/mlx-lm-lora) | - |
| MLX LoRA Studio | Native macOS interface for local MLX language-model fine-tuning with training metrics, run archives, and adapter export. | open-source | [Goekdeniz-Guelmez/MLX-LoRA-Studio](https://github.com/Goekdeniz-Guelmez/MLX-LoRA-Studio) | - |
| H2O LLM Studio | GUI and command-line framework for language-model fine-tuning, preference optimization, and experiment comparison. | open-source | [h2oai/h2o-llmstudio](https://github.com/h2oai/h2o-llmstudio) | - |
| Agent Lightning | Reinforcement-learning infrastructure that captures agent interactions through a model gateway and coordinates training with local or Kubernetes rollouts. | open-source | [microsoft/agent-lightning](https://github.com/microsoft/agent-lightning) | - |
| openpi | Robotics vision-language-action model software with checkpoint references, fine-tuning workflows, and JAX and PyTorch inference interfaces. | open-source | [Physical-Intelligence/openpi](https://github.com/Physical-Intelligence/openpi) | - |
...
| AlayaRenderer | Research code for video inverse rendering and text-guided generation from G-buffer inputs using adapted diffusion models. | research | [AlayaLab/AlayaRenderer](https://github.com/AlayaLab/AlayaRenderer) | - |
| ANEMLL Flash-MoE llama.cpp | llama.cpp fork with sidecar expert storage, streamed slot-bank execution, and trace tools for MoE inference on Apple Silicon. | open-source | [Anemll/anemll-flash-llama.cpp](https://github.com/Anemll/anemll-flash-llama.cpp) | - |
| h3-metal | Experimental native Metal runtime for MiniMax-H3 video and audio generation on Apple Silicon, with frame conditioning and ordered media references. | open-source | [antirez/h3.c](https://github.com/antirez/h3.c) | - |
| OpenLLM | CLI and model packaging tools for serving language models through BentoML and OpenAI-compatible APIs. | open-source | [bentoml/OpenLLM](https://github.com/bentoml/OpenLLM) | - |
| MFLUX | MLX-based image generation and editing tools with model-specific quantization and LoRA support. | open-source | [filipstrand/mflux](https://github.com/filipstrand/mflux) | - |
| Guidance | Python library for steering language-model generation with grammars, structured output, and programmatic control flow. | open-source | [guidance-ai/guidance](https://github.com/guidance-ai/guidance) | - |
| Splash | Apple Silicon inference engine serving supported packed models through compatible chat APIs, with model-specific Metal kernels and speculative decoding. | open-source | [incoai/splash](https://github.com/incoai/splash) | - |
| CoreML-LLM | Core ML conversion tools and a Swift library for running language and multimodal models on Apple devices. | open-source | [john-rocky/CoreML-LLM](https://github.com/john-rocky/CoreML-LLM) | - |
| Colibri | C inference engine for mixture-of-experts models with expert placement across storage, RAM, and GPU memory. | open-source | [JustVugg/colibri](https://github.com/JustVugg/colibri) | - |
| DDTree Research | CUDA/PyTorch research implementation of speculative decoding with block diffusion draft trees and target-model verification. | research | [liranringel/ddtree](https://github.com/liranringel/ddtree) | - |
| F5-TTS MLX | MLX implementation of F5-TTS for reference-conditioned speech generation on Apple silicon. | open-source | [lucasnewman/f5-tts-mlx](https://github.com/lucasnewman/f5-tts-mlx) | - |
| Orion | Experimental runtime for small language-model inference and training through Apple Neural Engine private APIs. | research | [mechramc/Orion](https://github.com/mechramc/Orion) | - |
| oLLM | Python inference library that offloads model weights and supported KV caches to storage for memory-constrained workloads. | open-source | [Mega4alik/ollm](https://github.com/Mega4alik/ollm) | - |
| Pi DS4 | Pi extension that manages local ds4 inference servers and model downloads. | open-source | [mitsuhiko/pi-ds4](https://github.com/mitsuhiko/pi-ds4) | - |
| MLX Swift LM | Swift libraries for loading, generating with, and fine-tuning language and vision-language models using MLX. | open-source | [ml-explore/mlx-swift-lm](https://github.com/ml-explore/mlx-swift-lm) | - |
| GPT4All | Desktop application and Python bindings for running supported language models locally, with local-document retrieval features. | open-source | [nomic-ai/gpt4all](https://github.com/nomic-ai/gpt4all) | - |
| kvcached | KV-cache memory manager that uses GPU virtual memory for demand-driven allocation and sharing across serving workloads. | open-source | [ovg-project/kvcached](https://github.com/ovg-project/kvcached) | - |
| PegaInfer | Rust and CUDA LLM serving engine with an OpenAI-compatible API, model-specific kernels, and shared KV-cache infrastructure. | open-source | [pegainfer-project/pegainfer](https://github.com/pegainfer-project/pegainfer) | - |
| openpi | Robotics vision-language-action model software with checkpoint references, fine-tuning workflows, and JAX and PyTorch inference interfaces. | open-source | [Physical-Intelligence/openpi](https://github.com/Physical-Intelligence/openpi) | - |
| FlashQLA | TileLang kernel library implementing Gated DeltaNet chunked-prefill forward and backward operations for supported NVIDIA GPUs. | open-source | [QwenLM/FlashQLA](https://github.com/QwenLM/FlashQLA) | - |
| SwiftLM | Swift inference server for MLX models on Apple Silicon with an OpenAI-compatible API. | open-source | [SharpAI/SwiftLM](https://github.com/SharpAI/SwiftLM) | - |
| Stability Generative Models | Generative-model codebase with model configurations and sampling tools for image, video, and multiview generation. | open-source | [Stability-AI/generative-models](https://github.com/Stability-AI/generative-models) | - |
| QVAC Fabric LLM | llama.cpp fork for cross-platform inference, multi-machine GPU execution, and LoRA fine-tuning. | open-source | [tetherto/qvac-fabric-llm.cpp](https://github.com/tetherto/qvac-fabric-llm.cpp) | - |
| YOLO MLX | MLX implementation of YOLO26 detection, tracking, segmentation, and pose estimation with training tools for Apple Silicon. | open-source | [thewebAI/yolo-mlx](https://github.com/thewebAI/yolo-mlx) | - |
...
| FrontierAgent | Open-source terminal agent runtime with task-scoped sandboxes, stateful ReAct and coordinated Agent Team workflows, and an included evaluation runner. | open-source | [ApodexAI/FrontierAgent](https://github.com/ApodexAI/FrontierAgent) | - |
| TrueCourse | Code analysis tool combining dependency graphs, deterministic rules, and LLM review for architecture and code-quality checks. | open-source | [truecourse-ai/truecourse](https://github.com/truecourse-ai/truecourse) | - |
| Agent Zero | Agent framework providing a containerized Linux desktop, browser tools, project memory, plugins, and host-machine integration. | open-source | [agent0ai/agent-zero](https://github.com/agent0ai/agent-zero) | - |
| BrowserCode | OpenCode-derived coding agent with persistent Chrome DevTools Protocol access and reusable browser automation scripts. | open-source | [browser-use/browsercode](https://github.com/browser-use/browsercode) | - |
| pi-codex-goal | Pi extension that persists goals in session history and provides goal tracking and continuation tools. | open-source | [fitchmultz/pi-codex-goal](https://github.com/fitchmultz/pi-codex-goal) | - |
| GitHub Spec Kit | CLI and templates for specification-driven development workflows across coding agents. | open-source | [github/spec-kit](https://github.com/github/spec-kit) | - |
| Herdr | Terminal workspace manager for coding agents with background sessions, local and SSH workspaces, pane status and CLI or socket control. | open-source | [herdrdev/herdr](https://github.com/herdrdev/herdr) | - |
| pi-computer-use | Pi extension for observing and operating desktop applications and browser pages through state-scoped UI tools. | open-source | [injaneity/pi-computer-use](https://github.com/injaneity/pi-computer-use) | - |
| Clawbox | Command-line tooling for provisioning and managing OpenClaw-ready macOS virtual machines with optional development synchronization. | open-source | [joshavant/clawbox](https://github.com/joshavant/clawbox) | - |
| Lossless Claw | OpenClaw context plugin that stores raw messages in SQLite and assembles active context from linked summaries and recent messages, with history-retrieval tools. | open-source | [martian-engineering/lossless-claw](https://github.com/martian-engineering/lossless-claw) | - |
| Playwright | Browser automation and testing framework for Chromium, Firefox and WebKit with isolated contexts, locators, retrying assertions and execution traces. | open-source | [microsoft/playwright](https://github.com/microsoft/playwright) | - |
| cco | Coding-agent launcher selecting native macOS or Linux sandboxing or Docker, with configurable filesystem access and backend-specific isolation. | open-source | [nikvdp/cco](https://github.com/nikvdp/cco) | - |
| OpenClaw FFmpeg WASM | Node.js interfaces to WebAssembly FFmpeg and FFprobe builds for media probing and preprocessing. | open-source | [openclaw/ffmpeg-wasm](https://github.com/openclaw/ffmpeg-wasm) | - |
| Iron Proxy | Outbound proxy for agent environments with destination policies, secret substitution, and request auditing. | open-source | [paradigmxyz/iron-proxy](https://github.com/paradigmxyz/iron-proxy) | - |
| HeadlessX | Self-hosted browser extraction platform with website operators, queued jobs, a dashboard, and API and MCP access. | open-source | [saifyxpro/HeadlessX](https://github.com/saifyxpro/HeadlessX) | - |
| Companions | Pi-based personal agent application with isolated runtimes, persistent conversations, files, and a PostgreSQL execution control plane. | open-source | [The-Vibe-Company/companion](https://github.com/The-Vibe-Company/companion) | - |
| GoalBuddy | Repository-backed goal boards with task scopes, work receipts, verification records, and handoffs between coding agents. | open-source | [tolibear/goalbuddy](https://github.com/tolibear/goalbuddy) | - |
| Ghist | Repository-local CLI that stores tasks, plans, and decision events as JSON files for continuity across coding-agent sessions. | open-source | [unnecessary-special-projects/ghist](https://github.com/unnecessary-special-projects/ghist) | - |
| FluidUse | Swift library for local Core ML decision inference and form interaction through macOS Accessibility and embedded WebKit. | open-source | [FluidInference/FluidUse](https://github.com/FluidInference/FluidUse) | - |
| Unreal Agent | Go agent harness with asynchronous tool operations, persisted session history, recovery, and session forks. | open-source | [unreallabsai/unreal-agent](https://github.com/unreallabsai/unreal-agent) | - |
...
| Centaur | Self-hosted team agent platform with Slack and API ingress, sandboxed execution, durable state, tool plugins, and workflows. | open-source | [paradigmxyz/centaur](https://github.com/paradigmxyz/centaur) | - |
| CAR | Ticket-based coordinator for long-running coding-agent workflows with persistent context, a web interface, and chat integrations. | open-source | [Git-on-my-level/codex-autorunner](https://github.com/Git-on-my-level/codex-autorunner) | - |
| Google AX | Declarative orchestrator for agent tasks, workspaces, network gateways, and sandbox lifecycles. | open-source | [google/ax](https://github.com/google/ax) | - |
| gnhf | CLI orchestrator that runs coding agents in bounded iterations with Git commits, persistent notes, retries, and rollback handling. | open-source | [kunchenguid/gnhf](https://github.com/kunchenguid/gnhf) | - |
| Manaflow | Workspace platform for parallel coding-agent runs with separate environments, terminals, application previews, and diff review. | open-source | [manaflow-ai/manaflow](https://github.com/manaflow-ai/manaflow) | - |
| pi-subagents | Pi extension for foreground and background agent delegation, reusable workflows, and bounded child-agent execution. | open-source | [nicobailon/pi-subagents](https://github.com/nicobailon/pi-subagents) | - |
| TinyAGI | Experimental agent-team framework with persistent sessions, queued message processing, team handoffs, channel adapters and a management dashboard. | open-source | [TinyAGI/tinyagi](https://github.com/TinyAGI/tinyagi) | - |
| Clowder AI | Coordinates multiple coding-agent backends with shared conversations, handoffs, and worktree workflows. | open-source | [zts212653/clowder-ai](https://github.com/zts212653/clowder-ai) | - |
| PentAGI | Autonomous pentesting agent — ChainAST for conversations (typed AST with structural validation, byte tracking, force-repair), Generator/Refiner adaptive replanning, 12+ specialized agents, three-phase summarization with provider-specific reasoning preservation | open-source | [vxcontrol/pentagi](https://github.com/vxcontrol/pentagi) | - |
| DSPy | Framework for programming LMs with automatic prompt and weight optimization | open-source | [stanfordnlp/dspy](https://github.com/stanfordnlp/dspy) | - |
...
| GitNexus | Code knowledge-graph indexer with CLI, MCP, and browser interfaces, available under a noncommercial license. | free | [abhigyanpatwari/GitNexus](https://github.com/abhigyanpatwari/GitNexus) | - |
| supacrawl | Mirrors Supabase and Postgres metadata and optional table rows into a local SQLite archive for search, inspection, export, and snapshot comparison. | open-source | [davemorin/supacrawl](https://github.com/davemorin/supacrawl) | - |
| anydoc | Rust document-to-Markdown converter with Node.js, Python, and WebAssembly bindings. | open-source | [firecrawl/anydoc](https://github.com/firecrawl/anydoc) | - |
| GBrain | Agent memory system with sourced facts, corrections, keyword and semantic retrieval, and optional synthesis and background enrichment. | open-source | [garrytan/gbrain](https://github.com/garrytan/gbrain) | - |
| Atomic | Self-hostable Markdown knowledge base with semantic search, linked notes, generated wiki articles, RAG chat, and MCP access. | open-source | [kenforthewin/atomic](https://github.com/kenforthewin/atomic) | - |
| MarkPDFDown | Python CLI that converts PDF pages and images into Markdown using vision-language models through LiteLLM. | open-source | [MarkPDFdown/markpdfdown](https://github.com/MarkPDFdown/markpdfdown) | - |
| Lossless Claw | OpenClaw context plugin that stores raw messages in SQLite and assembles active context from linked summaries and recent messages, with history-retrieval tools. | open-source | [martian-engineering/lossless-claw](https://github.com/martian-engineering/lossless-claw) | - |
| MarkaMD | Local Markdown editor that assembles selected notes into context bundles with file-path provenance. | open-source | [mattenarle10/markamd](https://github.com/mattenarle10/markamd) | - |
| MarkItDown | Python library and CLI that convert documents and other file formats into Markdown for language-model pipelines. | open-source | [microsoft/markitdown](https://github.com/microsoft/markitdown) | - |
| mgrep | Semantic search CLI that synchronizes project files to Mixedbread Search and integrates with coding agents. | open-source | [mixedbread-ai/mgrep](https://github.com/mixedbread-ai/mgrep) | - |
| Sirchmunk | Agentic file-search system combining lexical retrieval, document extraction, evidence exploration, and reusable knowledge artifacts. | open-source | [modelscope/sirchmunk](https://github.com/modelscope/sirchmunk) | - |
| SLayer | Embeddable semantic layer for database metrics and queries with search, inspection, and Python, CLI, REST, and MCP interfaces. | open-source | [MotleyAI/slayer](https://github.com/MotleyAI/slayer) | - |
| Katana | Configurable web crawler with standard and headless modes, JavaScript endpoint discovery, scope controls, and structured output. | open-source | [projectdiscovery/katana](https://github.com/projectdiscovery/katana) | - |
| LiteParse | Document parser with spatial text extraction, bounding boxes, page rendering, and configurable OCR. | open-source | [run-llama/liteparse](https://github.com/run-llama/liteparse) | - |
| Scrapy | Python framework for crawling websites and extracting structured data through configurable spiders and pipelines. | open-source | [scrapy/scrapy](https://github.com/scrapy/scrapy) | - |
| ttok | Command-line tool for counting, encoding, decoding, and truncating text with tiktoken tokenizers. | open-source | [simonw/ttok](https://github.com/simonw/ttok) | - |
| Birdclaw | Local Twitter/X archive application using SQLite search, a web interface and CLI, with optional cached live reads and a read-only MCP interface. | open-source | [steipete/birdclaw](https://github.com/steipete/birdclaw) | - |
| Summarize | Extracts and summarizes web pages, files, and audiovisual content through CLI and browser workflows. | open-source | [steipete/summarize](https://github.com/steipete/summarize) | - |
| Supavec | Document ingestion and retrieval application with APIs for file and text uploads, embeddings, search, and chat. | open-source | [supavec/supavec](https://github.com/supavec/supavec) | - |
...
| BrowserCode | OpenCode-derived coding agent with persistent Chrome DevTools Protocol access and reusable browser automation scripts. | open-source | [browser-use/browsercode](https://github.com/browser-use/browsercode) | - |
| mails | Email CLI and TypeScript SDK for agent workflows with sending, inbox search, attachments, and local synchronization. | open-source | [chekusu/mails](https://github.com/chekusu/mails) | - |
| Gridex | Database IDE with AI-assisted queries and an MCP server for schema inspection and controlled database operations. | open-source | [gridex/gridex](https://github.com/gridex/gridex) | - |
| Kanna | Web interface for coding agents with project sessions, approval prompts, and persistent local conversation history. | open-source | [jakemor/kanna](https://github.com/jakemor/kanna) | - |
| OpenChamber | Workspace for running and reviewing OpenCode sessions with goals, worktrees, previews, scheduling, and remote access. | open-source | [openchamber/openchamber](https://github.com/openchamber/openchamber) | - |
| gogcli | Google Workspace CLI with structured output, account selection, command controls, and an MCP interface. | open-source | [openclaw/gogcli](https://github.com/openclaw/gogcli) | - |
| goplaces | Go client and CLI for Google Places and selected Routes API workflows with typed requests and JSON output. | open-source | [openclaw/goplaces](https://github.com/openclaw/goplaces) | - |
| imsg | Command-line interface for reading message history and sending iMessage or SMS through macOS. | open-source | [openclaw/imsg](https://github.com/openclaw/imsg) | - |
| OpnForm | Form builder with an MCP integration for draft creation, form management, and submission queries. | open-source | [OpnForm/OpnForm](https://github.com/OpnForm/OpnForm) | - |
| Polymarket CLI | Rust command-line interface for querying Polymarket data and managing orders and positions with machine-readable JSON output. | open-source | [Polymarket/polymarket-cli](https://github.com/Polymarket/polymarket-cli) | - |
| Homelable | Self-hosted infrastructure inventory and topology application with an MCP server for querying and managing homelab data. | open-source | [Pouzor/homelable](https://github.com/Pouzor/homelable) | - |
| Birdclaw | Local Twitter/X archive application using SQLite search, a web interface and CLI, with optional cached live reads and a read-only MCP interface. | open-source | [steipete/birdclaw](https://github.com/steipete/birdclaw) | - |
| sag | Text-to-speech CLI for ElevenLabs and 60db with voice selection, playback, and audio-file output. | open-source | [steipete/sag](https://github.com/steipete/sag) | - |
| Swark | VS Code extension that uses GitHub Copilot models to generate editable Mermaid architecture diagrams from selected source files. | open-source | [swark-io/swark](https://github.com/swark-io/swark) | - |
| IDAssist | IDA Pro plugin for LLM-assisted function analysis, rename proposals, and document-backed binary investigation. | open-source | [symgraph/IDAssist](https://github.com/symgraph/IDAssist) | - |
| TablePro | Native database client with AI chat, SQL assistance, configurable model providers, and an MCP server for database access. | open-source | [TableProApp/TablePro](https://github.com/TableProApp/TablePro) | - |
...
| Open Wearables | Self-hosted wearable data platform with normalized APIs, webhooks, and an MCP server for AI assistants. | open-source | [the-momentum/open-wearables](https://github.com/the-momentum/open-wearables) | - |
| Executor | Shared integration catalog exposing OpenAPI, MCP and GraphQL tools to agents with configured connections and per-tool approval policies. | open-source | [UsefulSoftwareCo/executor](https://github.com/UsefulSoftwareCo/executor) | - |
| OpenAI Agents SDK | First-party SDK for building agent workflows with tools, handoffs, tracing, and guardrails | open-source | [openai/openai-agents-python](https://github.com/openai/openai-agents-python) | - |
| Mirage | Unified virtual filesystem for AI agents, mounting services such as S3, Google Drive, Slack, Gmail, and Redis so agents can use shell-native file operations | open-source | [strukto-ai/mirage](https://github.com/strukto-ai/mirage) | - |
| OpenClaw Agent Skills | Public shared skill catalog for agent workflows including autoreview, remote validation, transcript provenance, handoff, and session viewing | open-source | [openclaw/agent-skills](https://github.com/openclaw/agent-skills) | - |
...
| LLM-as-a-Verifier | Framework for scoring agent outputs with fine-grained LLM feedback for selection, progress tracking, and reinforcement learning. | open-source | [llm-as-a-verifier/llm-as-a-verifier](https://github.com/llm-as-a-verifier/llm-as-a-verifier) | - |
| Jacobian Lens | Reference research implementation for fitting Jacobian-based vocabulary readouts of transformer residual activations. | research | [anthropics/jacobian-lens](https://github.com/anthropics/jacobian-lens) | - |
| MoE Routing Atlas | Captures and visualizes token-level expert routing traces from supported mixture-of-experts models. | open-source | [DJLougen/moe-routing-atlas](https://github.com/DJLougen/moe-routing-atlas) | - |
| Kubescape | Kubernetes security scanner with manifest, image, and cluster checks plus an MCP interface. | open-source | [kubescape/kubescape](https://github.com/kubescape/kubescape) | - |
| Claude Code Usage Monitor | Terminal usage monitor for Claude Code with provenance-labeled limits, forecasts, machine-readable exports, and optional local history. | open-source | [Maciek-roboblog/Claude-Code-Usage-Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) | - |
| Playwright | Browser automation and testing framework for Chromium, Firefox and WebKit with isolated contexts, locators, retrying assertions and execution traces. | open-source | [microsoft/playwright](https://github.com/microsoft/playwright) | - |
| numbat | Local monitoring and rule-based detection for supported AI agents, with session reconstruction and optional denial requests through supported pre-action hooks. | open-source | [perplexityai/numbat](https://github.com/perplexityai/numbat) | - |
| Pixel Agents | Visual activity monitor for Claude Code sessions, available as a VS Code extension and a local browser interface. | open-source | [pixel-agents-hq/pixel-agents](https://github.com/pixel-agents-hq/pixel-agents) | - |
| MPP Tools | Cross-language conformance tests and SDK change-control tooling for the Machine Payments Protocol. | open-source | [tempoxyz/mpp-tools](https://github.com/tempoxyz/mpp-tools) | - |
...
| OpenWorker | Desktop AI coworker with file, terminal, integration, and scheduled workflows governed by permission and review mechanisms. | open-source | [andrewyng/openworker](https://github.com/andrewyng/openworker) | - |
| ChaosBlade BLADE AI | Kubernetes chaos-engineering agent that plans and coordinates ChaosBlade fault injection, confirmation, verification, and recovery workflows. | open-source | [chaosblade-io/chaosblade](https://github.com/chaosblade-io/chaosblade) | - |
| Inbox Zero | Email assistant for inbox organization, reply drafting, natural-language rules, and calendar and attachment workflows. | managed | [elie222/inbox-zero](https://github.com/elie222/inbox-zero) | - |
| Scratch | Desktop Markdown note editor with local files, external-change detection, and editing integrations for agent CLIs and Ollama. | open-source | [erictli/scratch](https://github.com/erictli/scratch) | - |
| Lago | Usage-based billing platform with event metering, pricing, credits, subscriptions, and invoicing for application workloads. | open-source | [getlago/lago](https://github.com/getlago/lago) | - |
| LTX Video Generator for Mac | SwiftUI application for local video generation on Apple Silicon with model selection, queued jobs, previews, and a local API. | open-source | [james-see/ltx-video-mac](https://github.com/james-see/ltx-video-mac) | - |
| Voicebox | Desktop voice studio for speech generation, reference-voice workflows, and audio editing across multiple engines. | open-source | [jamiepine/voicebox](https://github.com/jamiepine/voicebox) | - |
| Signal | Self-hosted sales workspace for company research, buying-signal monitoring, contact enrichment, and AI-assisted email outreach. | open-source | [jay-sahnan/signal](https://github.com/jay-sahnan/signal) | - |
| Jesse | Cryptocurrency strategy research framework with backtesting, machine-learning utilities, and an MCP interface. | open-source | [jesse-ai/jesse](https://github.com/jesse-ai/jesse) | - |
| Graphic Walker | Embeddable data exploration component with visual chart editing and configurable natural-language chart generation. | open-source | [Kanaries/graphic-walker](https://github.com/Kanaries/graphic-walker) | - |
| Open Notebook | Self-hosted research assistant for organizing sources, searching content, chatting with document context, and generating podcasts with configurable AI providers. | open-source | [lfnovo/open-notebook](https://github.com/lfnovo/open-notebook) | - |
| GPT4All | Desktop application and Python bindings for running supported language models locally, with local-document retrieval features. | open-source | [nomic-ai/gpt4all](https://github.com/nomic-ai/gpt4all) | - |
| Open-LLM-VTuber | Configurable voice and vision companion with Live2D avatars, chat history, and local or remote model backends. | open-source | [Open-LLM-VTuber/Open-LLM-VTuber](https://github.com/Open-LLM-VTuber/Open-LLM-VTuber) | - |
| OpsKat | Desktop server-operations workstation combining infrastructure clients with an optional AI interface to operational tools. | open-source | [opskat/opskat](https://github.com/opskat/opskat) | - |
| Odysseus | Self-hosted AI workspace combining chat, research, documents, and tool-enabled assistant workflows. | open-source | [pewdiepie-archdaemon/odysseus](https://github.com/pewdiepie-archdaemon/odysseus) | - |
| Flowsint | Graph-based OSINT investigation workspace with entity enrichment and LLM-assisted chat. | open-source | [reconurge/flowsint](https://github.com/reconurge/flowsint) | - |
| Scriberr | Self-hosted audio and video transcription with speaker diarization and optional transcript chat. | open-source | [rishikanthc/Scriberr](https://github.com/rishikanthc/Scriberr) | - |
| Whatomate | Self-hosted WhatsApp Business inbox with Cloud API integration, conversation workflows, and configurable AI replies. | open-source | [shridarpatil/whatomate](https://github.com/shridarpatil/whatomate) | - |
| Companions | Pi-based personal agent application with isolated runtimes, persistent conversations, files, and a PostgreSQL execution control plane. | open-source | [The-Vibe-Company/companion](https://github.com/The-Vibe-Company/companion) | - |
| Kimu | Video editor with multitrack timelines, rendering, and a Gemini-powered assistant that produces structured editing actions. | open-source | [trykimu/videoeditor](https://github.com/trykimu/videoeditor) | - |
| MerMark Editor | Desktop Markdown editor with Mermaid diagrams, presentations, and AI assistance through local models or coding CLIs. | open-source | [Vesperino/MerMarkEditor](https://github.com/Vesperino/MerMarkEditor) | - |
| FreeCut | Browser-based video editor with on-device transcription, scene analysis, speech synthesis, and music generation. | open-source | [walterlow/freecut](https://github.com/walterlow/freecut) | - |
